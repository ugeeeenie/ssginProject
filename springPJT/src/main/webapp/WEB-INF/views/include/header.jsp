			...
			<nav class="navbar navbar-static-top" role="navigation">
				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown call-menu">
							<a href="javascript:sendAndroidMsg('010-1234-5678')" class="">
						...
						<c:if test="${loginUser != null}">
							...
							<li class="dropdown user user-menu">
								...
								<img src="/resources/img/${loginUser.imgSrc}" class="user-image" alt="User Image" /> <span class="hidden-xs">
										${loginUser.name} </span>
							</a>
								<ul class="dropdown-menu">
									<!-- User image -->
									...
									<li class="user-footer">
										...
										<div class="pull-right">
											<a href="/user/logout.sinc" class="btn btn-default btn-flat">Sign
												out</a>
										</div>
									</li>
								</ul>
						...
						<c:if test="${loginUser == null}">
							...
							<li>
								<a href="/user/loginForm.sinc" data-toggle="">
						...
						<!-- Home Sidebar Button -->
						<li><a href="#" data-toggle=""> <i class="fa fa-home"
								aria-hidden="true"></i>
						</a></li>
					</ul>
				</div>
				...
				<c:if test="${loginUser != null}">
					<div class="user-panel">
						<div class="pull-left image">
							<img src="/resources/img/${loginUser.imgSrc}" class="img-circle"
								alt="User Image" />
						</div>
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							...
							<li><a href="/test/ssgin.sinc"><i class="fa fa-mobile" aria-hidden="true"></i>SSG IN TEST</a></li>
							<li><a href="/test/account.sinc"><i class="fa fa-id-card-o" aria-hidden="true"></i>송금하기</a></li>
						</ul></li>
					...
					<li class="treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li><a href="/charts/chartjs.sinc"><i
